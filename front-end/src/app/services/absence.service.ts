...
import { ADD_ABSENCE, ADD_ETUDIANT, DELETE_ETUDIANT, GET_ABSENCE_BY_ID, GET_ABSENCE_BY_ID_Etudiant, GET_ALL_ABSENCE, GET_MATIERE_BY_ID, GET_MATIERE_BY_NOM, UPDATE_ETUDIANT } from '../shared/constants/urls';
